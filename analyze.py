#analyzes med records of varying formats, converts them to a text file, deidentifies the data
#and enters it in a text file and finally depending on age and sex of individual prints out USPTF recs
#into a text file
import pytesseract
...
#collate_images(f'{ocr_files}', f'{ocr_files}/Darna_tesseract/')
